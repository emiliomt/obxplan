...
values
  ...
  ('Day 7',  'July 11',   'Final dinner + seafood boil at the house', 'Corolla',
   ...
   'This is not a normal sit-down restaurant dinner — a catered seafood boil or boil-at-home service at the rental in Corolla, so the last night feels special without extra driving south.',
   'Working catering / headcount target: 14 people. Especially well suited for a large group and a relaxed final-night gathering at the house.',
